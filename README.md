...
The extracted old token contract balances to be loaded into the new contract is at [upgradeTokenContract/oldTokenBalancesData.txt](upgradeTokenContract/oldTokenBalancesData.txt).
