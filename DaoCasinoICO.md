...
When compiling with Solidity 0.4.11, the following warnings are displayed:

```
DaoCasinoICO.sol:469:30: Warning: Unused local variable
    function receiveApproval(address _from, uint256 _value,
                             ^-----------^
DaoCasinoICO.sol:469:45: Warning: Unused local variable
    function receiveApproval(address _from, uint256 _value,
                                            ^------------^
DaoCasinoICO.sol:470:30: Warning: Unused local variable
                             ERC20 _token, bytes _extraData)
                             ^----------^
DaoCasinoICO.sol:470:44: Warning: Unused local variable
                             ERC20 _token, bytes _extraData)
                                           ^--------------^
```
