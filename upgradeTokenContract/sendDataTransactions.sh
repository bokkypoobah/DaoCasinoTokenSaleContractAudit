...
for (var i = 56; i < 68; i++) {
    ...
    var txId = newToken.fill(data[i], {from: account, gas: 2500000, gasPrice: web3.toWei(1, "gwei")});
...
if (false) {
  var sealTxId = newToken.seal({from: account, gas: 700000, gasPrice: web3.toWei(1, "gwei")});
